...
Ежемесячное пожертвование — это автоматическое пожертвование, 
которое списывается в один и тот же день месяца, начиная с даты подписки.

Именно благодаря вашей помощи мы можем продолжать делать добро. 🙏
...
Выберите сумму для ежемесячного списания:
    ...
    const keyboard = Markup.inlineKeyboard([
      [
        ...
        Markup.button.url('300 ₽', 'https://gaoordi.link/VZUZx'),
        Markup.button.url('500 ₽', 'https://gaoordi.link/VZUZx')
      ],
      [
        Markup.button.url('1000 ₽', 'https://gaoordi.link/VZUZx'),
